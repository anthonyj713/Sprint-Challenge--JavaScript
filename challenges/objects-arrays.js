...
console.log(tyrannosaurusObject.weight);

// What was the diet of a velociraptor?
console.log(velociraptorObject.diet);

// How long was a stegosaurus?
console.log(stegosaurusObject.length);

// What time period did tyrannosaurus live in?
console.log(tyrannosaurusObject.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(tyrannosaurusObject.roar);
...
console.log(graduates.filter(getUni));
...
const displayNames = [];
  function getDisplayNames(zooAnimals){
    zooAnimals.forEach(index=>{
      displayNames.push(`Name: ${index.animal_name}, ${index.scientific_name}.`)
    });
    return displayNames;
  }
getDisplayNames(zooAnimals);
...
const lowCaseAnimalNames = zooAnimals.map(index=>{
